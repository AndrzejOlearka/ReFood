...
export default class PanelRates extends Component {
            ...
            {this.state.rates ? (
                this.state.rates.map((rate, i) => {                
                    return(
                      ...
                      <div style={{background: regionsData[rate.recipe.region].colors.nav_footer}} className="panelTitle">
                          {rate.recipe.name}
                      </div>
                      <Stars rate={rate.rate} noHeader={true}/>
                  </div>
                    )
                })
            ) : (
